...
#define DISPLAYTEMPLATE 1     // 1 = Standard display template, 2 = Minimal template, 3 = only temperature, 4 = scale template, 20 = vertical display (see git Handbook for further information), 5 = Modern, Added by me (Clemens)
